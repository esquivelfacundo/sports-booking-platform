      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {activeSection === 'auth' && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
              <h3 className="text-gray-900 dark:text-white font-medium mb-3">Obtener tu API Key</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-gray-900 dark:text-white font-medium">Ejemplo de Header:</h3>
        ...
        {activeSection === 'create-booking' && (
          <div className="space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">Crea una nueva reserva en una cancha específica.</p>
          </div>
        )}
