        ...
        <AnimatePresence>
          {showSidebar && (
            <>
              ...
              <form id="expense-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
                <div>
              ...
              <div className="p-4 border-t border-gray-700 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <Loader2 className="w-4 h-4 animate-spin" />
                  ) : (
                    <span>{editingExpense ? 'Actualizar' : 'Registrar'}</span>
                  )}
                </button>
              </div>
              </motion.div>
