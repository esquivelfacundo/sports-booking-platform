            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-700">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  disabled={!establishmentId || !!displayOrder.invoiceId || pendingAmount > 0}
                  className="p-2 text-gray-400 hover:text-emerald-400 hover:bg-gray-700 rounded-lg transition-colors disabled:opacity-50"
                  title={displayOrder.invoiceId ? 'Ya facturado' : pendingAmount > 0 ? 'Debe estar pagado para facturar' : 'Facturar'}
                >
